...
def cc_callback():
    ...
    print(auth_code)
    ref_token = get_refresh_token(redirect_uri, CC_CLIENT_ID, CC_CLIENT_SECRET, auth_code)["refresh_token"]
...
def cc_create_contact():
    ...
    keys_json = get_access_token_ref(redirect_uri, CC_CLIENT_ID, CC_CLIENT_SECRET, ref_token)
